...
def format_data(account):    
    ...
    return f"{account_name}, a(n) {account_description}, from {account_country}"

def check_answer(guess, a_followers, b_followers): 
    '''Take user guess and followers count and return if they got it right'''
...
while game_should_continue:
    ...
    # Get follow count on each account
